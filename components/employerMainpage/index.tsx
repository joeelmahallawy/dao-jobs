...
import { Dao, Daos } from '../../utils/types'
...
import RenderJobs from '../seekerMain/renderJobsForDao'
import getAllDaos from '../../helpers/graphql/queries/getAllDaos'
...
const EmployerMainPage = ({
    ...
    return (
        ...
        >
            <TabList borderRadius={10} mb="1em">
                <Tab
                    borderRadius={5}
                    _focus={{}}
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Flex gap={['0.75rem', '1rem', '2rem']}>
                                            ...
                                            currentDao.twitterUrl.toLowerCase() !=
                                                'n/a' ? (
                                                <Link
                                                    _focus={{}}
                                                    _hover={{
